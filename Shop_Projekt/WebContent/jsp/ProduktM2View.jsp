...
<body>
	...
	<table>
		<tr>
			<td rowspan="2"><img src="../img/herrenImg/m-e.jpg"
				title="Striped Cube Tee" /></td>
			<td><h4>Striped Cube Tee 14,99 €</h4> <jsp:getProperty
		...
		<tr>
			<td class="beschreibung"><h4>Beschreibung</h4>
				<ul>
					<li>T-Shirt | Schwarz-Rot</li>
					<li>Basic Fit</li>
					<li>Rundhalsausschnitt</li>
					<li>100% Baumwolle</li>
					<li>Das Model ist 185 cm und trägt Größe L</li>
				</ul> <details>
